import random
from typing import Counter, Iterator, Union

import pandas as pd
from repo.totem_lib import ObjectCentricEventLog
...
def _valid_sequences_to_ocel(valid_sequences_iter, idx_to_act, idx_to_ot, objects_unique_per_sequence):
    ...
    """
    raise NotImplementedError("Verify ObjectCentricEventLog discovery; then adapt this function to use it instead of PM4Py OCEL.")
