...
def find_variants_naive(ocel: ObjectCentricEventLog, leading_type: str) -> Variants:
    """
    The provided naive discovery, now with performance timers for each step.
...
if __name__ == "__main__":
    from repo.totem_lib.ocel.ocel import ObjectCentricEventLog
    import json
    from repo.totem_lib.ocel.ocel import load_events_from_json, load_objects_from_json
